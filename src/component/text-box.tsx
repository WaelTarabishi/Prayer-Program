  ...
  return (
    <div className="grid relative grid-cols-2  z-10   px-32">
      ...
      <div className="grid-cols-1 w-[calc(45vw)] p-6 flex flex-col justify-center">
        <h3 className="text-2xl font-arabic text-amber-900 mb-4 text-center">حديث نبوي شريف</h3>
      ...
      <div style={{
      backgroundImage: "url(\"data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M30 0L60 30L30 60L0 30z' fill='none' stroke='%23805500' stroke-width='1'/%3E%3C/svg%3E\")",
      ...
      <div className="relative border-[calc(0.5vw+2px)] border-amber-700/90 bg-gradient-to-br from-amber-50 to-amber-100/90 rounded-lg p-[calc(1vw+0.5rem)] shadow-xl">
        ...
        <div className="absolute left-[calc(1vw+0.25rem)] top-[calc(3vw+2.3rem)] bottom-[calc(3vw+1rem)] w-[calc(0.4vw+0.2rem)] bg-repeat-y"
             style={{ 
               backgroundImage: "url(\"data:image/svg+xml,%3Csvg width='10' height='40' viewBox='0 0 10 40' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M5 0 L10 5 L5 10 L0 5 L5 0 Z M5 10 L10 15 L5 20 L0 15 L5 10 Z M5 20 L10 25 L5 30 L0 25 L5 20 Z M5 30 L10 35 L5 40 L0 35 L5 30 Z' fill='%23b45309' fill-opacity='0.4' /%3E%3C/svg%3E\")",
               backgroundSize: "100% auto" 
             }}>
        </div>
        
        <div className="absolute right-[calc(1vw+0.25rem)] top-[calc(3vw+2.3rem)] bottom-[calc(3vw+1rem)] w-[calc(0.4vw+0.2rem)] bg-repeat-y"
             style={{ 
               backgroundImage: "url(\"data:image/svg+xml,%3Csvg width='10' height='40' viewBox='0 0 10 40' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M5 0 L10 5 L5 10 L0 5 L5 0 Z M5 10 L10 15 L5 20 L0 15 L5 10 Z M5 20 L10 25 L5 30 L0 25 L5 20 Z M5 30 L10 35 L5 40 L0 35 L5 30 Z' fill='%23b45309' fill-opacity='0.4' /%3E%3C/svg%3E\")",
               backgroundSize: "100% auto" 
             }}>
